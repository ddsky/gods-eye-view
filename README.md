...
| 📰 **World News**           | The latest place-tagged headlines pinned where each headline points and colored by tone — coverage of what is being written about, not verified incidents                                                                                                                                                                                                                           | World News API                          | 🟡                                                                                                  |
...
| 🟡  | **World News API** | 📰 Place-tagged world headlines pinned on the globe (free plan: 50 points/day, resets 00:00 UTC — the layer budgets 40)                                                              | [worldnewsapi.com](https://worldnewsapi.com/console/) — free signup                                                                                                  |
...
| **🟡 The free-key tier** | **$0 with a signup.** AISStream, FIRMS, TomTom, World News API, OpenSky, plus Cesium ion for eligible personal/non-commercial use. Provider quotas and eligibility still apply.                                                                                                                                                                                             |
